...
class AIAssistantChatbot {
    ...
    initSpeechRecognition() {
        ...
        this.recognition.lang = 'en-US'; // Default, will be adaptive based on input

        this.recognition.onstart = () => {
            this.isListening = true;
            this.voiceInputBtn.classList.add('listening');
            this.input.placeholder = '🎤 Listening (English/हिंदी/Hinglish)...';
        ...
        this.recognition.onerror = (event) => {
            ...
            this.input.placeholder = '🎤 Error - please try again';
        };
